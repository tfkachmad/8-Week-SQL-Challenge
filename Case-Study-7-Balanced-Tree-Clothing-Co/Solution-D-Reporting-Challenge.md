...
- To easily change the value for each month, a variable called `@MonthName` provided. This variable value can be easily changed to get the report for different month, for this example January is used.
- Before creating the actual report, a subset from the dataset is used just to filter the data to be used based on the month value provided by the `@MonthName` variable.
...
1. **High Level Sales Table**
    ...
    - The high level sales analysis table
...
3. **Member vs. Non-Member Transaction Table**
    ...
    - The member vs. non-member transaction table
...
4. **Top 3 Products of The Month Table**
    ...
    - Top 3 product of the month table
...
9. **Product Revenue By Segment**
    ...
    - Product revenue by segment table
...
10. **Revenue By Segment For Each Category**
